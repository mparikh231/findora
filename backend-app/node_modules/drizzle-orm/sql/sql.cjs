...
class View {
  ...
  [IsDrizzleView] = true;
  /** @internal */
  get [import_table_utils.TableName]() {
    return this[import_view_common.ViewBaseConfig].name;
  }
  /** @internal */
  get [import_table.Schema]() {
    return this[import_view_common.ViewBaseConfig].schema;
  }
  /** @internal */
  get [import_table.IsAlias]() {
    return this[import_view_common.ViewBaseConfig].isAlias;
  }
  /** @internal */
  get [import_table.OriginalName]() {
    return this[import_view_common.ViewBaseConfig].originalName;
  }
  /** @internal */
  get [import_table.Columns]() {
    return this[import_view_common.ViewBaseConfig].selectedFields;
  }
