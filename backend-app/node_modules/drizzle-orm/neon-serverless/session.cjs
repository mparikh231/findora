...
class NeonSession extends import_session.PgSession {
  ...
  async transaction(transaction, config = {}) {
    const session = this.client instanceof import_serverless.Pool ? new NeonSession(await this.client.connect(), this.dialect, this.relations, this.schema, this.options) : this;
