...
import { type BuildRelationalQueryResult, type DBQueryConfig, type TableRelationalConfig, type TablesRelationalConfig } from "../relations.cjs";
...
import type { GelMaterializedView, GelView } from "./view.cjs";
...
export declare class GelDialect {
    ...
    buildRelationalQuery({ tables, schema, tableNamesMap, table, tableConfig, queryConfig: config, relationWhere, mode, errorPath, depth, throughJoin, }: {
