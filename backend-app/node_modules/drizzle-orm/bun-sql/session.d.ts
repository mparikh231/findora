...
export declare class BunSQLSession<TSQL extends SQL, TFullSchema extends Record<string, unknown>, TRelations extends AnyRelations, TTablesConfig extends TablesRelationalConfig, TSchema extends V1.TablesRelationalConfig> extends PgSession<BunSQLQueryResultHKT, TFullSchema, TRelations, TTablesConfig, TSchema> {
    client: TSQL;
    private relations;
    private schema;
    static readonly [entityKind]: string;
    ...
    transaction<T>(transaction: (tx: BunSQLTransaction<TFullSchema, TRelations, TTablesConfig, TSchema>) => Promise<T>, config?: PgTransactionConfig): Promise<T>;
}
export declare class BunSQLTransaction<TFullSchema extends Record<string, unknown>, TRelations extends AnyRelations, TTablesConfig extends TablesRelationalConfig, TSchema extends V1.TablesRelationalConfig> extends PgTransaction<BunSQLQueryResultHKT, TFullSchema, TRelations, TTablesConfig, TSchema> {
    static readonly [entityKind]: string;
    constructor(dialect: PgDialect, 
    /** @internal */
    session: BunSQLSession<TransactionSQL | SavepointSQL, TFullSchema, TRelations, TTablesConfig, TSchema>, relations: AnyRelations | undefined, schema: V1.RelationalSchemaConfig<TSchema> | undefined, nestedIndex?: number);
    transaction<T>(transaction: (tx: BunSQLTransaction<TFullSchema, TRelations, TTablesConfig, TSchema>) => Promise<T>): Promise<T>;
}
